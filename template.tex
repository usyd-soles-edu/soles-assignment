...
%% colours
\definecolor{light}{HTML}{FCEDE2}
\definecolor{highlight}{HTML}{E64626}
...
\AddToShipoutPicture{% 
    ...
    \AtPageLowerLeft{% start the bar at the bottom right of the page
        \put(\LenToUnit{\dimexpr\paperwidth-2.5cm},27.2cm){% move it to the top right
            \color{light}\includegraphics[width=2cm]{images/usydlogo.png}
          }%
     }%
}
...
\hypersetup{
  pdftitle={Lab 01 (Week 01) -- Title goes here},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
