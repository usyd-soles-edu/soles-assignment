...
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[enhanced, boxrule=0pt, sharp corners, breakable, borderline west={3pt}{0pt}{shadecolor}, frame hidden, colback={codebgcolor}]}{\end{tcolorbox}}\fi

\setstretch{1.2}
\hypertarget{welcome}{%
\subsection{Welcome}\label{welcome}}

\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, toptitle=1mm, breakable, colback=white, colbacktitle=quarto-callout-tip-color!10!white, rightrule=.15mm, opacityback=0, colframe=quarto-callout-tip-color-frame, opacitybacktitle=0.6, left=2mm, leftrule=.75mm, titlerule=0mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Learning outcomes}, arc=.35mm, bottomrule=.15mm, coltitle=black, bottomtitle=1mm]
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, toptitle=1mm, breakable, colback=white, colbacktitle=quarto-callout-tip-color!10!white, rightrule=.15mm, opacityback=0, colframe=quarto-callout-tip-color-frame, opacitybacktitle=0.6, left=2mm, leftrule=.75mm, titlerule=0mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{ANSWER}, arc=.35mm, bottomrule=.15mm, coltitle=black, bottomtitle=1mm]
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, toptitle=1mm, breakable, colback=white, colbacktitle=quarto-callout-tip-color!10!white, rightrule=.15mm, opacityback=0, colframe=quarto-callout-tip-color-frame, opacitybacktitle=0.6, left=2mm, leftrule=.75mm, titlerule=0mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Step 1: Sit on human}, arc=.35mm, bottomrule=.15mm, coltitle=black, bottomtitle=1mm]
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, toptitle=1mm, breakable, colback=white, colbacktitle=quarto-callout-warning-color!10!white, rightrule=.15mm, opacityback=0, colframe=quarto-callout-warning-color-frame, opacitybacktitle=0.6, left=2mm, leftrule=.75mm, titlerule=0mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warning}, arc=.35mm, bottomrule=.15mm, coltitle=black, bottomtitle=1mm]
